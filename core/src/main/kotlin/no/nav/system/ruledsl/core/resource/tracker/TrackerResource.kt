...
abstract class TrackerResource<R> : AbstractResource() {
     ...
     */
    internal open fun onFaktumCreated(faktum: Faktum<*>, parent: AbstractRuleComponent) {}

    /**
     * Called when a Rule begins evaluation.
     */
    internal open fun onRuleEvaluationStart(rule: Rule<*>) {}

    /**
     * Called when a Rule completes evaluation.
     * Accumulate HVORFOR (why this decision was made).
     */
    internal open fun onRuleEvaluationEnd(rule: Rule<*>, fired: Boolean) {}

    /**
     * Called when a TrackablePredicate (domain predicate) is evaluated.
     * Accumulate specific conditions that led to decisions.
     */
    internal open fun onPredicateEvaluated(predicate: TrackablePredicate, rule: Rule<*>, result: Boolean) {}

    /**
     * Called when entering a ruleset.
     */
    internal open fun onRulesetEnter(component: AbstractRuleComponent) {}

    /**
     * Called when exiting a ruleset.
     */
    internal open fun onRulesetExit(component: AbstractRuleComponent) {}
