...
private inline fun <T : Any> faktumValue(
    ...
    operator: PairOperator,
    crossinline eval: () -> Boolean
): Uttrykk<Boolean> = comparison(faktum, Const(value), operator, eval)
...
private inline fun <T : Any> valueFaktum(
    ...
    operator: PairOperator,
    crossinline eval: () -> Boolean
): Uttrykk<Boolean> = comparison(Const(value), faktum, operator, eval)
...
private inline fun <T : Any> valueValue(
    ...
    operator: PairOperator,
    crossinline eval: () -> Boolean
): Uttrykk<Boolean> = comparison(Const(left), Const(right), operator, eval)
...
infix fun Faktum<LocalDate>.erFørEllerLik(other: Faktum<LocalDate>): Uttrykk<Boolean> =
    comparison(this, other, PairOperator.FØR_ELLER_LIK) { this.verdi <= other.verdi }

@JvmName("faktum_localdate_erFørEllerLik_localdate")
infix fun Faktum<LocalDate>.erFørEllerLik(other: LocalDate): Uttrykk<Boolean> =
    faktumValue(this, other, PairOperator.FØR_ELLER_LIK) { this.verdi <= other }
...
infix fun Faktum<LocalDate>.erEtterEllerLik(other: Faktum<LocalDate>): Uttrykk<Boolean> =
    comparison(this, other, PairOperator.ETTER_ELLER_LIK) { verdi >= other.verdi }
...
infix fun Faktum<LocalDate>.erEtterEllerLik(other: LocalDate): Uttrykk<Boolean> =
    faktumValue(this, other, PairOperator.ETTER_ELLER_LIK) { verdi >= other }

@JvmName("faktum_localdate_erEtter_localdate")
infix fun Faktum<LocalDate>.erEtter(other: LocalDate): Uttrykk<Boolean> =
    faktumValue(this, other, PairOperator.ETTER) { verdi > other }
...
infix fun Faktum<LocalDate>.erEtter(other: Faktum<LocalDate>): Uttrykk<Boolean> =
    comparison(this, other, PairOperator.ETTER) { verdi > other.verdi }
...
infix fun <T : Any> Faktum<T>.erLik(ap: T): Uttrykk<Boolean> =
    faktumValue(this, ap, PairOperator.LIK) { this.verdi == ap }

@JvmName("faktum_erLik_faktum")
infix fun <T : Any> Faktum<T>.erLik(ap: Faktum<T>): Uttrykk<Boolean> =
    comparison(this, ap, PairOperator.LIK) { this.verdi == ap.verdi }

@JvmName("faktum_erUlik_value")
infix fun <T : Any> Faktum<T>.erUlik(ap: T): Uttrykk<Boolean> =
    faktumValue(this, ap, PairOperator.ULIK) { this.verdi != ap }

@JvmName("faktum_erUlik_faktum")
infix fun <T : Any> Faktum<T>.erUlik(ap: Faktum<T>): Uttrykk<Boolean> =
    comparison(this, ap, PairOperator.ULIK) { this.verdi != ap.verdi }

/**
 * Number-specific equality operators (for value-to-value comparisons)
 */
@JvmName("number_erLik_number")
infix fun Number.erLik(other: Number): Uttrykk<Boolean> =
